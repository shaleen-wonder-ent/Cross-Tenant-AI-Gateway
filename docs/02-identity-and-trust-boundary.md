...
See [diagrams/04-identity-and-token-sequence.png](../diagrams/04-identity-and-token-sequence.png) for the full 14-step sequence, and [phase-2-implementation/docs/05-apim-gateway-configuration.md](../phase-2-implementation/docs/05-apim-gateway-configuration.md) for the policy XML that implements this (build-out phase).
