...
- [ ] Decide per client: cross-tenant Private Link, or public endpoint + IP allow-list (see [docs/03-networking-and-private-link.md](../../docs/03-networking-and-private-link.md))
...
- [ ] Run a joint walkthrough with the client covering [diagrams/05-animated-call-flow.png](../../diagrams/05-animated-call-flow.png) so the request/response/metering paths are visually clear
